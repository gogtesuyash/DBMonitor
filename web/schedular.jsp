...
<script type="text/javascript">
 $(function() {
	...
	<form method="POST" action='Schedular' name="frmSchedule">
	<div class="content">
		...
		<tr>
			<td> </td>
			<td>Schedular will fetch all statistical data from all machines enrolled with "DBMonitor"</td>
		</tr>
		<tr class="blank_row">
		</tr>
		<tr>
				<td></td>
				<td><input type="checkbox" name="schedular" value="run"><b>Enable Schedular</b></td>
		</tr>
		<tr class="blank_row">
		</tr>
		<tr>
