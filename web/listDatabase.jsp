...
.tsc_tables2_0 td {
    background: -moz-linear-gradient(100% 25% 90deg, #fefefe, #f9f9f9) repeat scroll 0 0 rgba(0, 0, 0, 0);
}
.tsc_tables2_0 tr.odd-row td {
    background: -moz-linear-gradient(100% 25% 90deg, #f6f6f6, #f1f1f1) repeat scroll 0 0 rgba(0, 0, 0, 0);
}
.tsc_tables2_0 th {
    background: -moz-linear-gradient(100% 20% 90deg, #e8eaeb, #ededed) repeat scroll 0 0 rgba(0, 0, 0, 0);
}
...
.tsc_tables2_4 th {
    ...
    background: -moz-linear-gradient(center bottom , rgb(201, 201, 201) 20%, rgb(231, 231, 231) 80%) repeat scroll 0 0 rgba(0, 0, 0, 0);
...
<script type="text/javascript">
 $(function() {
    ...
    <table class="tsc_tables2_0" cellspacing="0">
        <thead>
            <tr>
                <th>Id</th>
                <th>Host Name</th>
        ...
        <tbody>
            <c:forEach items="${databases}" var="database">
                <tr>
                    <td><c:out value="${database.id}" /></td>
                    <td><c:out value="${database.hostName}" /></td>
                    <td><c:out value="${database.platform}" /></td>
					
                    <td><c:out value="${database.dbType}" /></td>
                    <td><c:out value="${database.dbName}" /></td>
                    <td><c:out value="${database.port}" /></td>
                    <td><c:out value="${database.userName}" /></td>
                    <td><c:out value="${database.password}" /></td>
                    <td><a href="DBController?action=edit&id=<c:out value="${database.id}"/>">Update</a></td>
                    <td><a href="DBController?action=delete&id=<c:out value="${database.id}"/>">Delete</a></td>
                </tr>
            </c:forEach>
        </tbody>
    </table>
    <p align="right" style="margin-right:290px;"><a href="DBController?action=insert">Add Machine</a></p>
</body>
</html>